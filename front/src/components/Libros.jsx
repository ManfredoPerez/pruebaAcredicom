...
import { getLibros, deleteLibros, addLibros, updateLibros } from "../service/librosService";
...
const Libros = () => {
    ...
    const validar = () => {
        if (nombre.trim() === '') {
            ...
            if (operacion === 1) {
                addLibros(user).then(() => fetchAutor());
            } else {
                updateLibros(id, user).then(() => fetchAutor());
            }
    ...
    const handleDelete = (id, nombre) => {
        ...
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                deleteLibros(id).then(() => fetchAutor());
            } else {
                    ...
                    <div className="col-12 col-lg-8 offset-lg-2">
                        <div className="table-responsive">
                            <table className="table table-bordered">
                                <thead>
                                    <tr> <th>#</th> <th>Libro</th> <th>Nombre Nombre</th> <th>Apellido</th>  <th></th> </tr>
                                </thead>
